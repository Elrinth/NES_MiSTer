...
Release: mapper682-20260910 (2026-09-10).
...
Copy NES_20260910_mapper682_spritefix.rbf to the MiSTer SD card's _Console folder
...
```sh
git clone --branch mapper682-20260910 https://github.com/Elrinth/NES_MiSTer.git
cd NES_MiSTer
quartus_sh --flow compile NES
```

Use Intel/Altera Quartus Prime Lite 17.0 with Cyclone V device support. The build
used the theypsilon/quartus-lite-c5:17.0 Docker environment. NES.qsf sets seed 5;
...
The matching core-source hashes and timing report are in releases/mapper682-20260910/.
